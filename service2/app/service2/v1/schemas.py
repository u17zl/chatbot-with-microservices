...
definitions = {'definitions': {'Timeslot': {'type': 'object', 'properties': {'time': {'type': 'string', 'description': 'time', 'example': '9:00 am'}}}, 'Error': {'type': 'object', 'properties': {'code': {'type': 'string'}, 'message': {'type': 'string'}}, 'required': ['code', 'message']}}, 'parameters': {}}

validators = {
    ('timeslots_id', 'POST'): {'args': {'required': ['time'], 'properties': {'time': {'type': 'string', 'description': 'Time.'}}}},
    ('timeslots_id', 'DELETE'): {'args': {'required': ['time'], 'properties': {'time': {'type': 'string', 'description': 'Time.'}}}},
}

filters = {
    ('timeslots_id', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Timeslot'}}}, 404: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}},
    ('timeslots_id', 'POST'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}},
    ('timeslots_id', 'DELETE'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}},
}
