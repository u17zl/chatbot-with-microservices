...
definitions = {'definitions': {'Dentist': {'type': 'object', 'properties': {'id': {'type': 'integer', 'format': 'int64', 'example': 1}, 'name': {'type': 'string', 'description': 'name', 'example': 'Dr. Alex'}, 'location': {'type': 'string', 'description': 'location', 'example': 'Randwick'}, 'specialization': {'type': 'string', 'description': 'specialization', 'example': 'Oral Surgery'}}}, 'Error': {'type': 'object', 'properties': {'code': {'type': 'string'}, 'message': {'type': 'string'}}, 'required': ['code', 'message']}}, 'parameters': {}}

validators = {
}

filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Dentist'}}}, 404: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}},
    ('dentists_name', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/Dentist'}}, 404: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}},
}
