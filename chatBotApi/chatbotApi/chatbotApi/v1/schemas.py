...
definitions = {'definitions': {'message': {'type': 'object', 'properties': {'message': {'type': 'string', 'description': 'meesage text', 'example': 'Hello Kevin!'}, 'details': {'type': 'array', 'items': {'type': 'object', 'description': 'details in message', 'properties': {'id': {'type': 'integer', 'example': 1}, 'time': {'type': 'string', 'example': '13:00 pm'}, 'location': {'type': 'string', 'example': 'Randwick'}, 'name': {'type': 'string', 'example': 'Dr. Lee'}, 'specialization': {'type': 'string', 'example': 'Paediatric Dentistry'}}}}}}}, 'parameters': {}}

validators = {
    ('say', 'POST'): {'json': {'$ref': '#/definitions/message'}},
}

filters = {
    ('say', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 400: {'headers': None, 'schema': None}},
}
